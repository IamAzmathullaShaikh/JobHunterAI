...
function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-indigo-500/30">
      {/* Toast Notification */}
      {toastMessage && (
        <div className="fixed bottom-8 right-8 z-[100] bg-slate-800 border-l-4 border-emerald-400 text-slate-100 px-4 py-3 rounded-lg shadow-2xl flex items-center gap-2.5 max-w-sm animate-slide-in">
